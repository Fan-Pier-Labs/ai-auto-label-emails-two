...
export function Options() {
  return (
    <section id="options" className="px-6 py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col rounded-2xl border border-border bg-card p-8">
            ...
            <h3 className="mb-2 text-2xl font-bold text-foreground">Self-Host</h3>
            ...
            <div className="mb-8 flex-1 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-foreground">100% free and open source</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">Full control over your data</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">Use local AI with Ollama</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">Deploy anywhere (Docker, AWS, etc.)</span>
              </div>
            </div>
          ...
          <div className="relative flex flex-col rounded-2xl border-2 border-primary bg-card p-8">
            ...
            <h3 className="mb-2 text-2xl font-bold text-foreground">Hosted</h3>
            <p className="mb-6 text-muted-foreground">
            ...
            <div className="mb-8 flex-1 space-y-3">
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">No technical setup required</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">Automatic updates and maintenance</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">Premium AI models included</span>
              </div>
              <div className="flex items-start gap-3">
                <Check className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
                <span className="text-sm text-foreground">Priority support from our team</span>
              </div>
            </div>
