...
// TODO: this will have to be just get a string from the uuser
// and the rule from the fe as well
// and call gemni to see if its a match
// can use the same prompt as the one in the processor
